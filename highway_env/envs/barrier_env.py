...
class barrier_env(AbstractEnv):
    ...
    def default_config(cls) -> dict:
        ...
        config.update({
            ...
            "left_lane_reward": 0,  # The reward received when driving on the right-most lanes, linearly mapped to
    ...
    def _create_vehicles(self) -> None:
        ...
        for i in range(len(accident_2)):
            vehicle1 = other_vehicles_type.create_accident_slow_car(
                    cls=Vehicle, road=self.road,
                    longitudinal=accident_2[i][0],
                    lateral=accident_2[i][1],
    ...
    def _rewards(self, action: Action) -> Dict[Text, float]:
        ...
        for this_vehicle in self.controlled_vehicles:
            ...
            y_persition.append(this_vehicle.position[1])
        ...
        return {
            ...
            "left_lane_reward": 1/(1+max(y_persition)),
